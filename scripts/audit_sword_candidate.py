...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'runs/navigation-sword-v1'
...
def main():
 ...
 (OUT/'audit.json').write_text(json.dumps(result,indent=2));(ROOT/'reports/navigation-sword-v1-audit.json').write_text(json.dumps(result,indent=2))
