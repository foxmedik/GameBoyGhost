"""One fixed route candidate, with shortest verified labels and parent retention."""
import argparse
import json
...
def train(out):
    ...
    (out/'training-plan.json').write_text(json.dumps(metadata,indent=2));shutil.copy2(__file__,dest/'train_navigation_routes.py')
